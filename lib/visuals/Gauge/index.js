...
export class Gauge extends BaseVisual {
  ...
  renderPointer(d, i, maxTickTextFontSize) {
    ...
    return qcharts.h(Polygon, _extends({}, attr, style, {
      animation: this.resolveAnimation(_objectSpread(_objectSpread({}, pointerAnimation), {}, {
        duration: 300
      }))
    }));
  }
  ...
  render() {
    ...
    return qcharts.h(Group, {
      ...
      return qcharts.h(Group, {
        ...
        zIndex: 10,
        animation: this.resolveAnimation(_objectSpread(_objectSpread({}, this.animations[i]), {}, {
          duration: 300
        }))
      }, gradientColor ? {
