...
export class Progress extends BaseVisual {
  ...
  transform(data) {
    ...
    return data.map((d, i) => {
      ...
      var attrs = _objectSpread(_objectSpread({}, d), {}, {
        anchor: [0.5, 0.5],
        color,
        radius,
        maxRadius: radius,
  ...
  renderWave(d, i) {
    ...
    return qcharts.h(Wave, _extends({}, d, this.style('normal')(d, d.dataOrigin, i), d.disabled ? {
      ...
      percent: d.percent,
      ref: el => animate(el),
      animation: _objectSpread(_objectSpread({}, this.animations[i]), {}, {
        duration: 300
      })
    }));
  }
  ...
  renderPies(d, i, data) {
    ...
    return qcharts.h(Group, {
      ...
      zIndex: j + 1,
      endAngle: t.endAngle,
      animation: _objectSpread(_objectSpread({}, onlyOne ? isArray(this.animations[i]) ? this.animations[i][0] : this.animations[i] : this.animations[i][j]), {}, {
        duration: 300
      })
    }))));
  }
  ...
  render(data) {
    ...
    return qcharts.h(Group, {
      ...
      return qcharts.h(Group, {
        ...
        onMousemove: evt => this.dataset.hoverData(_objectSpread(_objectSpread({}, evt), {}, {
          data: _objectSpread(_objectSpread({}, d.dataOrigin), {}, {
            color: d.color
          })
        })),
        onMouseleave: (_, el) => {
